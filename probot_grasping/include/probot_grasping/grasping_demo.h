...
class GraspingDemo {
 private:
  ...
  VisionManager vMng_;
  /**
   * @brief camera_to_robot takes care of the transformation from camera to
   * robot frame
   */
  ...
  /**
   * @brief pregrasp_x, pregrasp_y and pregrasp_z is the pregrasp position of
   * arm
   */
 ...
 public:
   ...
   */
  GraspingDemo(ros::NodeHandle n_, float pregrasp_x, float pregrasp_y,
               float pregrasp_z, float length = 1, float breadth = 0.6);
  /**
